...
ORDER = [
    ...
    ("foundations/09-contemporary-japanese.md", "Contemporary Japanese"),
    ("foundations/10-role-language.md", "Role Language"),
    ...
    ("politeness/05-modern-keigo.md", "Modern Keigo"),
    ...
    ("culture/09-vtuber-and-streaming.md", "Vtubers & Streaming"),
