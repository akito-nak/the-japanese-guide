# Core Vocabulary — The 500 Words That Carry You Everywhere

> *"Research suggests the top 1,000 words in any language cover about 85% of everyday speech. Learn the top 500 and you're already more than halfway there."*

This isn't a random word dump. Every word here was chosen because it appears constantly in daily Japanese life — on signs, in conversation, on menus, in news. Master these and almost every real-world situation becomes navigable.
...
|---|---|---|---|
| おはようございます | ohayō gozaimasu | Good morning | Drop ございます with close friends |
| こんにちは | konnichiwa | Hello / Good afternoon | |
| こんばんは | konbanwa | Good evening | |
| おやすみなさい | oyasuminasai | Good night | |
| さようなら | sayōnara | Goodbye (formal, somewhat final) | |
| じゃあね / またね | jā ne / mata ne | See you / Bye (casual) | |
| ありがとうございます | arigatō gozaimasu | Thank you very much | |
| ありがとう | arigatō | Thank you (casual) | |
| どういたしまして | dō itashimashite | You're welcome | |
| すみません | sumimasen | Excuse me / I'm sorry | Multi-purpose: getting attention, minor apology |
| ごめんなさい | gomen nasai | I'm sorry (sincere) | |
| はい | hai | Yes | |
| いいえ | iie | No | |
| そうです | sō desu | That's right | |
| そうですね | sō desu ne | I see / Yes, indeed | Agreement/consideration |
| よろしくお願いします | yoroshiku onegaishimasu | Please treat me well / Nice to meet you | Said constantly — at introductions, when asking favors |
| はじめまして | hajimemashite | Nice to meet you (first meeting) | |
| おげんきですか | ogenki desu ka | How are you? | |
| おかげさまで | okagesama de | Thanks to you, I'm fine | Polite response to above |
...
> **Japan uses 万 (10,000)** as a base unit, not thousand. So 30,000 is 三万 (sanman), not "thirty thousand." This trips up English speakers when reading prices.
...
| 午前 | gozen | AM |
| 午後 | gogo | PM |
| 〜時 | ~ji | o'clock (3時 = 3 o'clock) |
| 〜分 | ~fun/pun | minutes (30分 = 30 minutes) |
| 〜秒 | ~byō | seconds |
| 週末 | shūmatsu | weekend |
| 平日 | heijitsu | weekday |

### Days of the Week
| Japanese | Kanji | Day | Memory trick |
|---|---|---|---|
| 月曜日 | getsuyōbi | Monday | 月 = moon |
| 火曜日 | kayōbi | Tuesday | 火 = fire |
| 水曜日 | suiyōbi | Wednesday | 水 = water |
| 木曜日 | mokuyōbi | Thursday | 木 = wood/tree |
| 金曜日 | kin'yōbi | Friday | 金 = gold/money |
| 土曜日 | doyōbi | Saturday | 土 = earth |
| 日曜日 | nichiyōbi | Sunday | 日 = sun |

### Months
January = 一月 (ichigatsu), February = 二月 (nigatsu) ... December = 十二月 (jūnigatsu). Simple: number + 月.
...
|---|---|---|---|
| 家族 | kazoku | family | |
| 父 / お父さん | chichi / otōsan | father | chichi = my father; otōsan = someone else's / respectful |
| 母 / お母さん | haha / okāsan | mother | same pattern |
| 兄 / お兄さん | ani / oniisan | older brother | |
| 姉 / お姉さん | ane / onēsan | older sister | |
| 弟 | otōto | younger brother | |
| 妹 | imōto | younger sister | |
| 祖父 / おじいさん | sofu / ojiisan | grandfather | |
| 祖母 / おばあさん | sobo / obāsan | grandmother | |
| 夫 / 旦那 | otto / danna | husband | |
| 妻 / 奥さん | tsuma / okusan | wife | |
| 息子 | musuko | son | |
| 娘 | musume | daughter | |
| 友達 | tomodachi | friend | |
...
| コーヒー | kōhī | coffee |
| ビール | bīru | beer |
| 酒 / お酒 | sake / osake | sake / alcohol in general |
| ラーメン | rāmen | ramen |
| 寿司 | sushi | sushi |
| 天ぷら | tenpura | tempura |
...
| Japanese | Romaji | Meaning |
|---|---|---|
| 家 / うち | ie / uchi | house / home (uchi = "my home") |
| 学校 | gakkō | school |
...
| Japanese | Romaji | Meaning |
|---|---|---|
| ある / いる | aru / iru | to exist (thing / person) |
| する | suru | to do |
| 来る | kuru | to come |
| 行く | iku | to go |
...
| 思う | omou | to think (opinion) |
| 考える | kangaeru | to think (deliberate) |
| 忘れる | wasureru | to forget |
| 覚える | oboeru | to memorize / remember |
...
| Japanese | Romaji | Meaning |
|---|---|---|
| でも | demo | but / however (casual) |
| しかし | shikashi | however (formal) |
| そして | soshite | and then / and |
| それから | sorekara | and after that |
...
| 日本語が少しだけ話せます。 | nihongo ga sukoshi dake hanasemasu. | I can speak a little Japanese. |
